...
(function () {
  ...
  var ru = {
    ...
    'Компанія':'Компания','Про нас':'О нас','Послуги':'Услуги','Блог':'Блог','Фінансування':'Финансирование','Калькулятор окупності':'Калькулятор окупаемости','Запитання та відповіді':'Вопросы и ответы','Контакти':'Контакты','Телефон':'Телефон','Графік роботи':'График работы','ОСББ':'ОСМД',
    'Київ, вул. Велика Васильківська, 72':'Киев, ул. Большая Васильковская, 72','Пн-Пт: 9:00 – 18:00':'Пн–Пт: 9:00–18:00','Пн–Пт: 9:00 – 18:00':'Пн–Пт: 9:00–18:00','© 2026 Rayton. Усі права захищені':'© 2026 Rayton. Все права защищены','Політика конфіденційності':'Политика конфиденциальности','Умови використання':'Условия использования'
  };
  var en = {
    ...
    'Компанія':'Company','Про нас':'About us','Послуги':'Services','Блог':'Blog','Фінансування':'Financing','Калькулятор окупності':'Payback calculator','Запитання та відповіді':'FAQ','Контакти':'Contacts','Телефон':'Phone','Графік роботи':'Business hours','ОСББ':'Homeowners associations',
    'Київ, вул. Велика Васильківська, 72':'72 Velyka Vasylkivska St, Kyiv','Пн-Пт: 9:00 – 18:00':'Mon–Fri: 9:00–18:00','Пн–Пт: 9:00 – 18:00':'Mon–Fri: 9:00–18:00','© 2026 Rayton. Усі права захищені':'© 2026 Rayton. All rights reserved','Політика конфіденційності':'Privacy policy','Умови використання':'Terms of use'
  };
