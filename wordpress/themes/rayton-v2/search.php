<?php get_header(); ?>
<main class="site-main search-index">
	<header class="archive-header"><h1><?php printf( esc_html__( 'Search results for: %s', 'rayton-v2' ), esc_html( get_search_query() ) ); ?></h1></header>
	<?php if ( have_posts() ) : ?>
